...
using Content.Client.UserInterface.Systems.Notifications;
...
public sealed class GameTopMenuBarUIController : UIController
{
    ...
    [Dependency] private readonly NotificationUiController _notifications = default!;
